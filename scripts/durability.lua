----------------------------------------------------------------------------------------
-- 在角色界面物品位上显示耐久度 (tekability by Tekkub)
----------------------------------------------------------------------------------------
local SLOTIDS = {}
...
--		local font, _, flags = NumberFontNormal:GetFont()
		fstr:SetFont(SettingsCF.media.pixel_font, SettingsCF.media.pixel_font_size, SettingsCF.media.pixel_font_style)
...
function frame:OnEvent(event, arg1)
	if event == "ADDON_LOADED" and arg1:lower() ~= "meatUI" then
