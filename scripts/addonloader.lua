...
SettingsDB.CreateStylePanel(loadf, 0.1, 0.8, 0.5, 3)
loadf:Hide()
...
SettingsDB.CreateSkinButton(reloadb)
...
SettingsDB.CreateStylePanel(addonf, 0.1, 0.8, 0.5, 3)
...
SettingsDB.CreateSkinButton(addonset1)
...
SettingsDB.CreateSkinButton(addonset2)
...
SettingsDB.CreateSkinButton(addonset3)
...
SettingsDB.CreateSkinButton(addonset4)
...
SettingsDB.CreateSkinButton(addonset5)
...
SettingsDB.CreateSkinButton(addonset6)
...
local makeList = function()
	local self = mainf
	SettingsDB.CreateTemplate(scrollf, 0)
...
SettingsDB.CreateSkinButton(showb)
...
if not IsAddOnLoaded("meatUI_Config") then return end
...
SettingsDB.CreateSkinButton(guib)
