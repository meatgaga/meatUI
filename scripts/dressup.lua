...
local function DoAH()
	...
	newbutton(nil, nil, "T", w, h, tb, "目标", function()
	...
	newbutton("CloseUpAHResetButton", du, "R", 20, 22, nil, "重置", function() du:Dress() end):SetPoint("RIGHT", tb, "LEFT", 0, 0)
	newbutton("CloseUpAHUndressButton", du, "U", 20, 22, nil, "脱衣", function() du:Undress() end):SetPoint("LEFT", tb, "RIGHT", 0, 0)
	ToggleBG(true)
end
...
do
	...
	newbutton(nil, nil, "目标", w, h, tb, "目标", function()
		if UnitExists("target") and UnitIsVisible("target") then 
	...
	newbutton("CloseUpUndressButton", DressUpFrame, "脱衣", w, h, nil, "脱衣", function() m:Undress() end):SetPoint("LEFT", tb, "RIGHT", -2, 0)
end
