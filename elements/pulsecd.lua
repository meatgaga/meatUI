...
DCPT:SetPoint("TOPLEFT", DCP, "TOPLEFT", SettingsDB.Scale(1), SettingsDB.Scale(-1))
DCPT:SetPoint("BOTTOMRIGHT", DCP, "BOTTOMRIGHT", SettingsDB.Scale(-1), SettingsDB.Scale(1))
DCP:SetBackdrop({
