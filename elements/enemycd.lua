...
local CreateIcon = function()
	...
	icon.Cooldown:SetPoint("TOPLEFT", SettingsDB.Scale(1), SettingsDB.Scale(-1))
	icon.Cooldown:SetPoint("BOTTOMRIGHT", SettingsDB.Scale(-1), SettingsDB.Scale(1))
	icon.Cooldown:SetReverse()
	icon.Texture = icon:CreateTexture(nil, "BORDER")
	icon.Texture:SetPoint("TOPLEFT", SettingsDB.Scale(1), SettingsDB.Scale(-1))
	icon.Texture:SetPoint("BOTTOMRIGHT", SettingsDB.Scale(-1), SettingsDB.Scale(1))
	return icon
end
