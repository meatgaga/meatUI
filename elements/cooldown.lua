...
local function Timer_Create(self)
	...
	if scale < 0.5 then
		...
		text:SetPoint("CENTER", SettingsDB.Scale(0.5), SettingsDB.Scale(1))
--		if self:GetParent():GetName() then
			text:SetFont(SettingsCF.media.pixel_font, SettingsCF.media.pixel_font_size * 2, SettingsCF.media.font_style)
--		else
--			text:SetFont(SettingsCF.media.pixel_font, 8, SettingsCF.media.font_style)
--		end
