if SettingsCF.combattext.enable ~= true then return end
----------------------------------------------------------------------------------------
...
elseif SettingsDB.class == "PRIEST"then
	if(ct.mergeaoespam)then
		-- Healer spells
...
elseif SettingsDB.class == "SHAMAN"then
	if(ct.mergeaoespam)then
...
elseif SettingsDB.class == "MAGE"then
	if(ct.mergeaoespam)then
...
elseif SettingsDB.class == "WARRIOR"then
	if(ct.mergeaoespam)then
...
elseif SettingsDB.class == "HUNTER"then
	if(ct.mergeaoespam)then
		ct.aoespam[2643]=true		-- Multi-Shot
	end
elseif SettingsDB.class == "DEATHKNIGHT"then
	if(ct.mergeaoespam)then
...
elseif SettingsDB.class == "ROGUE"then
	if(ct.mergeaoespam)then
...
if(ct.stopvespam and SettingsDB.class == "PRIEST")then
