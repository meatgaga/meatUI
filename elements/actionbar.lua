...
SettingsDB.buttonspacing = SettingsDB.Scale(SettingsCF.actionbar.button_spacing)

local fbar1 = CreateFrame("Frame", "Bar1Holder", UIParent)
fbar1:SetWidth((SettingsDB.buttonsize * 12) + (SettingsDB.buttonspacing * 11))
fbar1:SetHeight(SettingsDB.buttonsize + 2)
fbar1:SetPoint(unpack(SettingsCF.position.actionbars.bottom_bars))
fbar1:Show()

local fbar2 = CreateFrame("Frame", "Bar2Holder", UIParent)
fbar2:SetWidth((SettingsDB.buttonsize * 12) + (SettingsDB.buttonspacing * 11))
fbar2:SetHeight(SettingsDB.buttonsize + 2)
fbar2:SetPoint("BOTTOM", "Bar1Holder", "TOP", 0, -1)
fbar2:Show()

local fbar3 = CreateFrame("Frame", "Bar3Holder", UIParent)
if SettingsCF.actionbar.rightbars_three == true then
	fbar3:SetHeight((SettingsDB.buttonsize * 12) + (SettingsDB.buttonspacing * 11))
	fbar3:SetWidth(SettingsDB.buttonsize + 2)
else
	fbar3:SetWidth((SettingsDB.buttonsize * 12) + (SettingsDB.buttonspacing * 11))
	fbar3:SetHeight(SettingsDB.buttonsize + 2)
	fbar3:SetPoint("BOTTOM", "Bar2Holder", "TOP", 0, -1)
end
fbar3:Show()

local fbar45 = CreateFrame("Frame", "Bar45Holder", UIParent)
if SettingsCF.actionbar.rightbars_three == true then
	fbar45:SetWidth((SettingsDB.buttonsize * 3) + (SettingsDB.buttonspacing * 2))
	fbar45:SetHeight((SettingsDB.buttonsize * 12) + (SettingsDB.buttonspacing * 11))
else
	fbar45:SetWidth((SettingsDB.buttonsize * 2) + (SettingsDB.buttonspacing * 2))
	fbar45:SetHeight((SettingsDB.buttonsize * 12) + (SettingsDB.buttonspacing * 11))
end
fbar45:SetPoint(unpack(SettingsCF.position.actionbars.right_bars)) 
fbar45:Show()
...
if SettingsCF.actionbar.petbar_horizontal == true then
	fpet:SetWidth((SettingsDB.buttonsize * 10) + (SettingsDB.buttonspacing * 9))
	fpet:SetHeight(SettingsDB.buttonsize + 2)
else
	fpet:SetWidth(SettingsDB.buttonsize + 2)
	fpet:SetHeight((SettingsDB.buttonsize * 10) + (SettingsDB.buttonspacing * 9))
end
...
fshift:SetWidth(196)
fshift:SetHeight(SettingsDB.buttonsize + 2)
...
vehicle:SetWidth(SettingsDB.buttonsize)
vehicle:SetHeight(SettingsDB.buttonsize)
vehicle:SetPoint(unpack(SettingsCF.position.actionbars.vehicle)) 
SettingsDB.CreateTemplate(vehicle, 0.25)

vehicle:RegisterForClicks("AnyUp")
vehicle:SetScript("OnClick", function(self) VehicleExit() end)

vehicle:SetNormalTexture("Interface\\AddOns\\meatUI\\media\\textures\\vehicle")
vehicle:SetPushedTexture("Interface\\AddOns\\meatUI\\media\\textures\\vehicle")
vehicle:SetHighlightTexture("Interface\\AddOns\\meatUI\\media\\textures\\vehicle")
...
if SettingsCF.actionbar.rightbars_three == true then
	...
	MultiBarBottomRightButton1:SetPoint("TOPRIGHT", fbar45, "TOPRIGHT", -((SettingsDB.buttonsize * 2) + (SettingsDB.buttonspacing * 2) + 2), 0)
	for i = 2, 12 do
...
MultiBarLeftButton1:SetPoint("TOPRIGHT", fbar45, "TOPRIGHT", -(SettingsDB.buttonsize + SettingsDB.buttonspacing + 1), 0)
for i = 2, 12 do
...
PossessButton2:SetPoint("LEFT", PossessButton1, "RIGHT", SettingsDB.buttonspacing, 0)
...
local function MoveMicroButtons(skinName)
	...
	SocialsMicroButton:SetPoint("LEFT", QuestLogMicroButton, "RIGHT", -SettingsDB.buttonspacing, 0)
end
